...
* Optionally set `$invoiceAmount` to enable auto-accept only when invoice amount is greater than or equal to this value. Leave `false` to auto-accept everything
